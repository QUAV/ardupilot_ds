...
class AP_BattMonitor_Gov : public AP_BattMonitor_Backend
{
public:

    // Constructor
    AP_BattMonitor_Gov(AP_BattMonitor &mon, AP_BattMonitor::BattMonitor_State &mon_state, AP_BattMonitor_Params &params);
